  ...
  function init() {
    ...
    style.textContent = [
      '.coffee-fab{',
        ...
        'background:rgba(10,12,18,0.92);-webkit-',
        'border:1px solid rgba(253,230,138,0.35);border-radius:8px;',
      ...
      '@media (prefers-reduced-motion:reduce){.coffee-fab{opacity:1;transform:none;animation:none;transition:none;}}',
