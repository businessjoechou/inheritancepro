...
//
// 🚨 TODO（2026/7/1 前 cutover）：金管會 2026/2/12 已預告修正「強制汽車責任保險給付標準」，
//    2026/7/1（民國 115/7/1）施行。屆時應調整為：
//      COMPULSORY_DEATH_MAX: 2_000_000 → 3_000_000（死亡 & 第 1 級失能同步升 300 萬）
//      合計給付上限: 220 萬 → 320 萬（本模組目前未直接使用）
//    搭配提醒：accident.html、minor-damages.html UI 文字已標註「2026/7/1 起升為 300 萬」，
//    cutover 當日只需 (1) 改本常數、(2) 同步改 UI 硬編「200萬」字串、(3) 重跑 test-core
export const COMPULSORY_INJURY_MAX = 200_000;    // §2 傷害醫療給付上限 20 萬（僅抵醫療；2026/7/1 修正案不動）
export const COMPULSORY_DEATH_MAX  = 2_000_000;  // §6 死亡給付 200 萬（⚠️ 2026/7/1 生效為 300 萬，見上方 TODO）
